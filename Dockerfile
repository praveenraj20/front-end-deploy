...
#COPY /elements/ /opt/www/elements/# Make sure the important files/directories are owned by the nobody user
...
# EXPOSE 8080
# Kubernetes does not recognize text usernames so the uid of the nobody user is entered hereUSER 65534
# Start nginxCMD nginx